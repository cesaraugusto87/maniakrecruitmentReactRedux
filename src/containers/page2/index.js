...
class Calculator extends React.Component {
  ...
  render() {
    let { pageData, loading, monthlySpending, spendingRange, employeesRange } = this.props

    let annualSavings = employeesRange * 1337 + parseFloat(monthlySpending)

    return pageData && pageData.calculator && loading === false ? (
      <div>
        ...
        <div className={'calculator'}>
          ...
          <input
            ...
            step='1'
            value={employeesRange}
            onChange={this.handleAnnualRangeChange}
          />
          <div className={'leftSide'}>
